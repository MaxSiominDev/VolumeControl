...
import dev.maxsiomin.volume.annotations.ToastDuration
import dev.maxsiomin.volume.extensions.getDefaultSharedPrefs
...
class UiActionsImpl(override val context: Context) : UiActions {
    ...
    private val inputMethodManager
        by lazy { context.getSystemService(Context.INPUT_METHOD_SERVICE) as InputMethodManager }

    override val audioManager: AudioManager
        by lazy { context.getSystemService(Context.AUDIO_SERVICE) as AudioManager }
